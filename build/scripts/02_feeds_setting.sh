...
svn co https://github.com/immortalwrt/luci/tree/openwrt-23.05/applications/luci-app-onliner luci/applications/luci-app-onliner

# Add luci-app-udp2raw
git clone --depth=1 https://github.com/gngpp/luci-app-udp2raw luci/applications/luci-app-udp2raw
svn co https://github.com/immortalwrt/luci/tree/openwrt-23.05/net/udp2raw packages/net/udp2raw
...
# Add gotop
svn co https://github.com/immortalwrt/luci/tree/openwrt-23.05/admin/gotop packages/admin/gotop
